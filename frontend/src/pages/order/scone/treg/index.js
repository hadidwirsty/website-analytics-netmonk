...
export const OrderSconeTreg = () => {
  ...
  const getData = async () => {
    ...
    const dataURL = `${process.env.REACT_APP_API_BASE_URL}/scone/bytreg?username_treg=${username}`;
  ...
  const exportToCSV = () => {
    let csvData =
      'Nomor SC,Nama Pelanggan,Nomor Internet,Email Pelanggan,Witel,Status Fulfillment,Tanggal Order,Estimasi Selesai (WIB)\n';
