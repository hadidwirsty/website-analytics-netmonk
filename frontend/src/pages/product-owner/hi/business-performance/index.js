...
export const BusinessPerformance = () => {
  const title = 'Business Performance';
  const url = `${process.env.REACT_APP_API_BASE_URL_METABASE}/${process.env.REACT_APP_API_SEGMENT_URL_BUSINESS_PERFORMANCE}#bordered=false&titled=false`;
